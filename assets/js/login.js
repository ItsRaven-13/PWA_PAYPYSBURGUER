...
export function initializeLogin() {
  ...
  loginForm.onsubmit = async (e) => {
    ...
    try {
      ...
      // Asegurar persistencia antes de signIn
      ...
      console.log("Login exitoso, cargando catálogo...");
      ...
      if (errorDiv) {
        ...
        else if (err.code === "auth/too-many-requests") mensaje = "Demasiados intentos. Intenta más tarde.";
